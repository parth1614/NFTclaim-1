...
class App {
  ...
  async loadBlockchainData() {
    ...
    if(networkData) {
      ...
      const mint = await nft.methods.mint(userAddress, tokenId, amount).send({ from: userAddress })
    ...
    return (
      <div className="App">
        ...
        <div className="image-container">
          <img src="https://ik.imagekit.io/bayc/assets/ape3.png" className="image" alt="nft"/>
        </div>
